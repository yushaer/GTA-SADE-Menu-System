...
export class Menu {
  ...
  constructor(name, options, width, posx, posy, menucolor) {
    ...
    this.#option_posx =
      this.#posx + Math.round(this.#width / 2 - this.#option_width / 2, 0);
    this.#option_background_color = [
      menucolor[0],
      menucolor[1],
      menucolor[2],
      Math.round(1.05 * menucolor[3]),
    ];
  ...
  calculate_height() {
    if (this.#options.length <= this.#options_per_page) {
      this.#height =
        this.#options.length * (this.#outline_height + this.#heightoffset) +
        this.#heightoffset +
        10;
    } else {
      this.#height =
        this.#options_per_page * (this.#outline_height + this.#heightoffset) +
        this.#heightoffset +
        10;
    }
  }
